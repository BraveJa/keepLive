...
public class XiaoQiangService extends Service {
     ...
     *
     * 因 XiaoQiangService 运行在 :xiaoqiang 子进程, 请勿在主进程中直接调用此方法.
    ...
    public static class WatchDogNotificationService extends Service {
        ...
        public int onStartCommand(Intent intent, int flags, int startId) {
            startForeground(XiaoQiangService.HASH_CODE, new Notification());
            stopSelf();
            return START_STICKY;
        }
