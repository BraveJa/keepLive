...
import com.keeplive.zzwdaemon.receice.WakeUpReceiver;
...
public abstract class AbsWorkService extends Service {
    ...
    protected int onStart(Intent intent, int flags, int startId) {
        ...
        //启动守护服务，运行在:xiaoqiang子进程中
        DaemonEnv.startServiceMayBind(XiaoQiangService.class);
        ...
        if (mFirstStarted) {
            ...
            getPackageManager().setComponentEnabledSetting(new ComponentName(getPackageName(), XiaoQiangService.class.getName()),
