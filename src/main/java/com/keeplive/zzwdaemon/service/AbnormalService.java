...
public class AbnormalService extends Service {
	...
	public void onCreate() {
		...
		if (BuildConfig.DEBUG_DAEMON)
			Log.i(TAG, TAG + "---->onCreate,启动服务");
	...
	public void onDestroy() {
		...
		stopPlayMusic();
		if (BuildConfig.DEBUG_DAEMON)
			Log.i(TAG, TAG + "---->onCreate,停止服务");
		// 重启自己
		//Intent intent = new Intent(getApplicationContext(), AbnormalService.class);
		//startService(intent);
	}
}
