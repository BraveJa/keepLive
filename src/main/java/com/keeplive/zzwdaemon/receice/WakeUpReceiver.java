...
import com.keeplive.zzwdaemon.service.XiaoQiangService;
...
public class WakeUpReceiver extends BroadcastReceiver {
     ...
     */
    public static final String ACTION_CANCEL_JOB_ALARM_SUB = "com.keeplive.zzwdaemon.CANCEL_JOB_ALARM_SUB";
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null && ACTION_CANCEL_JOB_ALARM_SUB.equals(intent.getAction())) {
            XiaoQiangService.cancelJobAlarmSub();
            return;
        }
